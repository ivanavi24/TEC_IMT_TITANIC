...
second_motor(KP_2,KI_2,KD_2,POSITIVE_DIR_PIN_2,NEGATIVE_DIR_PIN_2,PWM_PIN_2,JOINT2_LOW_LIMIT_HW,JOINT2_HIGH_LIMIT_HW,JOINT2_LOW_LIMIT_SW,JOINT2_HIGH_LIMIT_SW),
third_motor(KP_3,KI_3,KD_3,POSITIVE_DIR_PIN_3,NEGATIVE_DIR_PIN_3,PWM_PIN_3,JOINT3_LOW_LIMIT_HW,JOINT3_HIGH_LIMIT_HW,JOINT3_LOW_LIMIT_SW,JOINT3_HIGH_LIMIT_SW){
  origin2water=0;
